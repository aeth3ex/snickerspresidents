...
const ru: Translations = {
  ...
  aiResponse: 'Ответ ИИ',
  pasteAiJson: 'Вставьте JSON ответ ИИ...',
  applyAi: 'Применить',
  textExport: 'Текстовый экспорт',
  refresh: 'Обновить',
  copyText: 'Копировать текст',
  aiNotebook: 'Блокнот ИИ',
  aiNotebookSecret: 'Блокнот ИИ (секретный)',
  showNotes: 'Показать',
  hideNotes: 'Скрыть',
  peekWarning: '⚠ ИИ узнает что вы заглянули',
  notesEmpty: 'Блокнот пуст — ИИ ещё ничего не записал',
  notesHint: 'Личные заметки ИИ. Если вы посмотрите — ИИ получит сигнал в следующем JSON.',
  noteTurn: 'ход',
  noteUpdated: 'изм.',
  ...
  devOnInfo: '🔓 Режим разработчика включён — все ограничения сняты',
  devOffInfo: '🔒 Режим разработчика отключён',
  codePlaceholder: 'Код',
  verify: 'OK',
...
const en: Translations = {
  ...
  pasteAiJson: 'Paste AI JSON response...',
  applyAi: 'Apply',
  textExport: 'Text Export',
  refresh: 'Refresh',
  copyText: 'Copy Text',
  aiNotebook: 'AI Notebook',
  aiNotebookSecret: 'AI Notebook (secret)',
  showNotes: 'Show',
  hideNotes: 'Hide',
  peekWarning: '⚠ AI will know you peeked',
  notesEmpty: 'Notebook is empty — AI hasn\'t written anything yet',
  notesHint: 'AI\'s private notes. If you look — AI gets a signal in the next JSON.',
  noteTurn: 'turn',
  noteUpdated: 'upd.',
